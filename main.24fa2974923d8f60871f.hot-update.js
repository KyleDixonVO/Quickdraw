...
class ScreenManager {
    ...
    showAmmo() {
        console.log(this.player.bulletsLeft);
        switch (this.player.bulletsLeft) {
            case 6:
                ...
                this.stage.addChildAt(this.bullet4, 0);
                this.stage.addChildAt(this.bullet5, 0);
                break;
            case 5:
                this.stage.addChildAt(this.bullet0, 0);
                this.stage.addChildAt(this.bullet1, 0);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("49c4ac9ae4f67fdae5eb")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.24fa2974923d8f60871f.hot-update.js.map