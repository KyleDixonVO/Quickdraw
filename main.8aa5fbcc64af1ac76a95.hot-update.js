...
class Enemy extends Character_1.Character {
    ...
    showMe() {
        ...
        this.startMe();
        this.stage.children.unshift(this._sprite);
        this._used = true;
    }
    hideMe() {
        super.hideMe();
    ...
    Shoot() {
        ...
        this._sprite.on("animationend", () => { this.player.health--; this._sprite.dispatchEvent(this.eventPlayerDamaged); this.Shoot(); }, this, true);
    }
    update() {
        super.update();
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b20fcf76f0c59909eae3")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.8aa5fbcc64af1ac76a95.hot-update.js.map