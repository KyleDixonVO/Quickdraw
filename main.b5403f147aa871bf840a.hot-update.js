...
function onReady(e) {
    ...
    for (let i = 0; i < Constants_1.ENEMY_MAX; i++) {
        enemyPool.push(new Bug_1.Bug(stage, assetManager));
    }
    ...
    switch (e.type) {
        ...
        case "enemyKilled":
            ...
            if ((enemiesKilled % 10) == 0) {
                bugDelay = bugDelay + Constants_1.ENEMY_DELAY_DECREASE;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("cd332f34bdddc9e65db6")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.b5403f147aa871bf840a.hot-update.js.map