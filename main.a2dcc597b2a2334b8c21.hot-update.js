...
class UserInterface {
    constructor(stage, assetManager) {
        ...
        this.bullet0 = assetManager.getSprite("sprites", "misc/Bullet", Constants_1.STAGE_WIDTH - 32, 50);
        stage.addChild(this.bullet0);
        this.bullet1 = assetManager.getSprite("sprites", "misc/Bullet", this.bullet0.x - 40, 50);
        stage.addChild(this.bullet1);
        this.bullet2 = assetManager.getSprite("sprites", "misc/Bullet", this.bullet1.x - 40, 50);
        stage.addChild(this.bullet2);
        this.bullet3 = assetManager.getSprite("sprites", "misc/Bullet", this.bullet2.x - 40, 50);
        stage.addChild(this.bullet3);
        this.bullet4 = assetManager.getSprite("sprites", "misc/Bullet", this.bullet3.x - 40, 50);
        stage.addChild(this.bullet4);
        this.bullet5 = assetManager.getSprite("sprites", "misc/Bullet", this.bullet4.x - 40, 50);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("fdec8bdab1dc1deca819")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.a2dcc597b2a2334b8c21.hot-update.js.map