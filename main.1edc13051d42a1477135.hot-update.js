...
class UserInterface {
    constructor(stage, assetManager) {
        ...
        this.bullet1 = assetManager.getSprite("sprites", "misc/Bullet", this.bullet0.x - 40, 60);
        stage.addChild(this.bullet1);
        this.bullet2 = assetManager.getSprite("sprites", "misc/Bullet", this.bullet1.x - 40, 60);
        stage.addChild(this.bullet2);
        this.bullet3 = assetManager.getSprite("sprites", "misc/Bullet", this.bullet2.x - 40, 60);
        stage.addChild(this.bullet3);
        this.bullet4 = assetManager.getSprite("sprites", "misc/Bullet", this.bullet3.x - 40, 60);
        stage.addChild(this.bullet4);
        this.bullet5 = assetManager.getSprite("sprites", "misc/Bullet", this.bullet4.x - 40, 60);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("a2dcc597b2a2334b8c21")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.1edc13051d42a1477135.hot-update.js.map